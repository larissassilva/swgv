...
<div class="row">
    ...
    <br>
    		 <button type="button" class="btn btn-primary btn-block" name="btnLogin" id="btnLogin" value="Acessar" onclick="login()">Acessar</button>
...
<div id="contact" class="container-fluid bg-grey">
  ...
  <div class="row">
    <div class="col-sm-12">
      <p style="text-align: justify;">Software Desenvolvido para o TCC - Trabalho de Conclusão de Curso, do Curso de Tecnologia em Análise e Desenvolvimento de Sistemas, IFG Câmpus Jataí. Sob a orientação do Professor Me.Sergio Henrique de Almeida
  e do Professor Me. Renato Oliveira Abreu. </p>
      </div>
      <div class="col-sm-4">
      <p><span class="glyphicon glyphicon-map-marker"></span> Jataí, GO</p>
      <p><span class="glyphicon glyphicon-phone"></span> +55 64984483195</p>
