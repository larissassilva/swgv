...
<div class="container a container-fluid">

    <h2>Nos Envie um Email</h2>
    ...
    <div class="col-sm-12 slideanim">
      ...
      <div class="row slide">
        ...
        <div class="col-sm-12 form-group">
            <textarea class="form-control" id="texto" name="texto" placeholder="Escreva aqui..." rows="5"></textarea><br>           
        </div>
      </div>
      
        <div class="col-sm-12 form-group slide">
          <button class="btn btn-default pull-right" id="btnEnviar" type="submit">Enviar</button>
        </div>
