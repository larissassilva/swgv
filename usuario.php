...
<h2 style='padding-left: 1.0em; color: #060e14; text-align: center;'>Cadastro de Usuário</h2>
</div>
          ...
          <div class="form-group col-12">
            <div class="row">
                  ...
                  <div class="col-lg-4 col-md-4 col-xs-12">
                    ...
                    <input type="date" name="datanascimento" class="datanascimento  form-control tamanho-form tamanho-form" placeholder="" required>
                  </div>

                  <div class="col-lg-6 col-md-6 col-xs-12">
                    <label for="fname">CPF</label>
                    <input type="text" id="cpf" name="cpf" class="cpf form-control tamanho-form"  placeholder="Digite só números" required>
                  </div>
                  <div class="col-lg-6 col-md-6 col-xs-12">
                  ...
                  <div class="col-lg-4 col-md-4 col-xs-12">
                    ...
                    <input type="text" name="cep" class="cep form-control tamanho-form" placeholder="Preencha Primeiro" id="cep" value="" size="10" maxlength="9"
               onblur="pesquisacep(this.value);" required>
                  ...
                  <div class="col-lg-12 col-md-12 col-xs-12">
                    ...
                    <input type="text" name="complemento" class="complemento form-control tamanho-form" placeholder="" required>
                  </div>

                  <div class="col-lg-8 col-md-8 col-xs-12">
                    <label for="fname">CNH Nº de Registro</label>
                    <input type="text" name="cnh" class="cnh form-control tamanho-form" placeholder="" required>
                  </div>
                  <div class="col-lg-4 col-md-4 col-xs-12">
                    <label for="fname">Categoria</label>
                    <input type="text" name="categoria" class="categoria form-control tamanho-form" placeholder="" required>
                  </div>
                  <div class="col-lg-6 col-md-6 col-xs-12">
                    <label for="fname">Data de Validade</label>
                    <input type="date" name="datavalidade" class="datavalidade form-control tamanho-form" placeholder="" required>
                  </div>
                  <div class="col-lg-6 col-md-6 col-xs-12">
                    <label for="fname">1ª Habilitação</label>
                    <input type="date" name="dataprimeiracnh" class="dataprimeiracnh form-control tamanho-form" placeholder="" required>
                  </div>
              </div>
            </div>
              ...
              <div class="row">
                <div class="modal-footer">
                  <div class="col-lg-12">
                      ...
                      <button id="salvar" type="submit" onclick="salvarDadosUsuario()" class="button2 btn btn-success">Salvar</button>
                  </div>
                </div>
                <div class="col-lg-12">
  ...
  <div class="modal-dialog container-fluid modal-tamanho">
    <div class="modal-content modal-content2">
      <div class="modal-header">
        ...
        <h4 class="modal-title"><b>Editar / Visualizar Usuário</b></h4>
      </div>
        ...
        <div class="modal-body">
          <div class="form-group col-12">
            <div class="row">
                  ...
                  <div class="col-lg-4 col-md-4 col-xs-12">
                    <label for="fname">Data de Nascimento</label>
                    <input type="" id="datanascimento" name="datanascimento" class="datanascimento  form-control tamanho-form tamanho-form" placeholder="dd/mm/aaaa" required>
                  </div>

                  <div class="col-lg-6 col-md-6 col-xs-12">
                    <label for="fname">CPF</label>
                    <input type="text" id="cpf" name="cpf" class="cpf form-control tamanho-form"  placeholder="" required>
                  </div>
                  <div class="col-lg-6 col-md-6 col-xs-12">
                    <label for="fname">Telefone</label>
                    <input type="text" id="telefone" name="telefone" class="telefone form-control tamanho-form" placeholder="" required>
                  </div>
           
                  <div class="col-lg-6 col-md-6 col-xs-12">
                    <label for="fname">Email</label>
                    <input type="text" id="email" name="email" class="email form-control tamanho-form"  placeholder="" required>
                  </div>
                  <div class="col-lg-6 col-md-6 col-xs-12">
                    <label for="fname">WhatsApp</label>
                    <input type="text" id="whatsapp" name="whatsapp" class="whatsapp form-control tamanho-form" placeholder="" required>
                  </div>
             
                  <div class="col-lg-4 col-md-4 col-xs-12">
                    <label for="fname">RG</label>
                    <input type="text" id="RG" name="RG" class="RG form-control tamanho-form" placeholder="" required>
                  </div>
                  <div class="col-lg-4 col-md-4 col-xs-12">
                    <label for="fname">Orgão Expedidor</label>
                    <input type="text" id="orgaoExpedidor" name="orgaoExpedidor" class="orgaoExpedidor form-control tamanho-form" placeholder="" required>
                  </div>
                  <div class="col-lg-4 col-md-4 col-xs-12">
                    <label for="fname">UF</label>
                    <input type="text" id="ufrg" name="ufrg" class="ufrg form-control tamanho-form" placeholder="" required>
                  </div>
              
                  <div class="col-lg-12 col-md-12 col-xs-12">
                    <label for="fname">Logradouro</label>
                    <input type="text" id="logradouro" name="logradouro" class="logradouro form-control tamanho-form" placeholder="" required>
                  </div>
              
                  <div class="col-lg-4  col-md-4 col-xs-12">
                    <label for="fname">Número</label>
                    <input type="text" id="numero" name="numero" class="numero form-control tamanho-form" placeholder="" required>
                  </div>
                  <div class="col-lg-4 col-md-4 col-xs-12">
                    <label for="fname">Bairro</label>
                    <input type="text" id="bairro" name="bairro" class="bairro form-control tamanho-form" placeholder="" required>
                  ...
                  <div class="col-lg-4 col-md-4 col-xs-12">
                    <label for="fname">CEP</label>
                    <input type="text" id="cep" name="cep" class="cep form-control tamanho-form" placeholder="" required>
                  </div>
                  ...
                  <div class="col-lg-6 col-md-6 col-xs-12">
                    <label for="fname">Estado</label>
                    <input type="text" id="estado" name="estado" class="estado form-control tamanho-form" placeholder="" required>
                  </div>
                  ...
                  <div class="col-lg-6 col-md-6 col-xs-12">
                    <label for="fname">Data de Validade</label>
                    <input type="" id="datavalidade" name="datavalidade" class="datavalidade form-control tamanho-form" placeholder="dd/mm/aaaa" required>
                  </div>
                  <div class="col-lg-6 col-md-6 col-xs-12">
                    <label for="fname">1ª Habilitação</label>
                    <input type="" id="dataprimeiracnh" name="dataprimeiracnh" class="dataprimeiracnh form-control tamanho-form" placeholder="dd/mm/aaaa" required>
                  </div>
            ...
            <div class="row">
                        <div class="modal-footer">
                            <div class="col-lg-12">
                                ...
                                <button type="button" onclick="limpar()" class="button3 btn btn-default" data-dismiss="modal">Cancelar</button>
                                <button id="editar" onclick="editarDadosUsuario()" type="button" class="button2 btn btn-success">Editar</button>
                            </div>
                        </div>
                        <div class="col-lg-12">
